...
async def register_new_user(user_create: UserCreate, db: Session) -> None:
    """
...
async def verify_new_user_email(user_verify: VerifyEmailRequest, db: Session) -> None:
    """
...
async def login_existing_user(login_request: LoginRequest, db: Session) -> dict[str, Any]:
    """
